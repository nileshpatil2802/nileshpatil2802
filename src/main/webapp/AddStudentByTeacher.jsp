...
<body>
	...
	<section class="container mt-3">
		...
		<div class="form-container ">
			<form action="AddStudentServletByTeacher" method="get" id="myForm">
				<table>
					<tr>
						<td>Student ID:</td>
				...
				<div class="mt-4 text-center">
					...
					<a href="TeacherPanel.jsp"><button type="button"
			...
			<form action="DeleteDataByCheckBox" method="get" id="myForm">
				...
				<table id="studentTable">
					...
					<tbody>
						...
						%>
						<tr>
							<td><input type="checkbox" id="emailCheckbox" name="email"
								value="<%=s1.getEmailID()%>"> <%=s1.getStudentID()%></td>
							<td><%=s1.getRollNo()%></td>
							<td><%=s1.getName()%></td>
